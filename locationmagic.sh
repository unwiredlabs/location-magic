...
Platform:
osx   = for macbooks
linux = for Linux (Ubuntu, etc)

Token = your token generated at https://locationmagic.org

Examples:
To install   = ./locationmagic_mac.sh -install osx xyz12345aabbcc
To uninstall = ./locationmagic_mac.sh -uninstall
To locate    = ./locationmagic_mac.sh -locate osx xyz12345aabbcc
"
